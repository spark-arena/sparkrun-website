...
State files live under `~/.cache/sparkrun/benchmarks/`. See [Resumable runs](/tutorials/benchmarking/#8-resumable-runs) in the benchmarking tutorial for more detail.
