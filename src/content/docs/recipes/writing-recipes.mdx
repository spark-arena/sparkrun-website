...
For more complex recipes involving [mods](recipes/format/#mods), [tunings](cli/tune/), or [benchmarks](cli/benchmark/#benchmark-profiles), it is recommended to first review the Sparkrun [security model](advanced/security/) so you can be aware of important limitations and caveats, and then set up your own [recipe registry](recipes/registries/).
