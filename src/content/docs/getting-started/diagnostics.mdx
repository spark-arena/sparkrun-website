...
:::note
The `log` records capture **all** log output at DEBUG level regardless of your console verbosity setting. This means the diagnostics file contains full SSH command output, script content, and internal state even when running with default (quiet) verbosity.
:::
