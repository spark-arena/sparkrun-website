            ...
            sidebar: [
                {
                    ...
                    items: [
                        ...
                        {label: 'Updates & Telemetry', slug: 'getting-started/updates'},
                    ],
                },
                {
                    label: 'Tutorials',
                    items: [
                        ...
                        {label: 'Benchmark on Spark Arena', slug: 'tutorials/spark-arena'},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {label: 'Schedulers & Placement', slug: 'advanced/schedulers'},
                        {label: 'Executors', slug: 'advanced/executors'},
                        {label: 'Multiplatform', slug: 'advanced/multiplatform'},
                        {label: 'Security & Trust', slug: 'advanced/security'},
                        {label: 'Feature Flags', slug: 'advanced/feature-flags'},
                        {label: 'External Plugins', slug: 'advanced/plugins'},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {label: 'recipe', slug: 'cli/recipe-commands'},
                        {label: 'cluster', slug: 'cli/cluster-commands'},
                        {label: 'setup', slug: 'cli/setup-commands'},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {label: 'Python API', slug: 'developer-reference/python-api'},
